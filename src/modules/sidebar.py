...
class Sidebar:
    ...
    def about():
        ...
        sections = [
            "#### AIKoBOT is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
            ...
            "#### Source code: [riccardogvn/AIKoBOT](https://github.com/riccardogvn/AIKoBOT)",
        ]
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ AIKoBOT tools", expanded=False):
